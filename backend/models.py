...
class InsulationMeasurement(Base):
    ...
    breaker_type = Column(String(50))
    breaker_value = Column(Numeric(10, 2))
    wire_material = Column(String(50))
    wire_cross_section = Column(Numeric(10, 2))
    zs_value_ohm = Column(Numeric(10, 4))
    du_value_percent = Column(Numeric(10, 2))
    fire_rating = Column(String(100))
...
class RcdTest(Base):
    ...
    breaker_type = Column(String(10), nullable=True)
    breaker_value = Column(String(20), nullable=True)
    wire_material = Column(String(10), nullable=True)
    wire_cross_section = Column(String(20), nullable=True)
    test_type = Column(String(50))
    rated_current_ma = Column(String(20), nullable=True)
    current_description = Column(String(100), nullable=True)
